...
```bash
wget https://github.com/messense/aliyundrive-fuse/releases/download/v0.1.6/aliyundrive-fuse_0.1.6_aarch64_generic.ipk
wget https://github.com/messense/aliyundrive-fuse/releases/download/v0.1.6/luci-app-aliyundrive-fuse_0.1.6_all.ipk
wget https://github.com/messense/aliyundrive-fuse/releases/download/v0.1.6/luci-i18n-aliyundrive-fuse-zh-cn_0.1.6-1_all.ipk
opkg install aliyundrive-fuse_0.1.6_aarch64_generic.ipk
opkg install luci-app-aliyundrive-fuse_0.1.6_all.ipk
opkg install luci-i18n-aliyundrive-fuse-zh-cn_0.1.6-1_all.ipk
```
